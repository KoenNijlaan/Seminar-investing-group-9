...
print("Processing daily RSJ files...\n")
...
weekly = (
    ...
    .agg(
        rsj_sum=("rsj_sum", "sum"),
        rsj_count=("rsj_count", "sum"),
        n_obs_total=("n_obs_total", "sum")
    )
)

weekly["rsj_weekly"] = weekly["rsj_sum"] / weekly["rsj_count"]
...
print("\nSummary:")
print(weekly["rsj_weekly"].describe())

output_file = output_dir / "rsj_weekly.parquet"
